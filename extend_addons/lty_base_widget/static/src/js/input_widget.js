odoo.define('lty_widget_buckets', function (require) {
    "use strict";
    ...
    // 自动升序组件（引用 widget="line_sequence"）
    var sequence = common.AbstractField.extend(common.ReinitializeFieldMixin, {
    ...
    core.form_widget_registry.add('line_sequence', sequence);

    // 转时间组件（引用 widget="input_time"）
    var toTime = common.AbstractField.extend(common.ReinitializeFieldMixin, {
        is_field_number: true,        
        template: "toTimeTemplate",
        internal_format: '',
        widget_class: 'oe_form_field_sequence',
        events: {
            'change input': 'store_dom_value',
    ...
    core.form_widget_registry.add('input_time', toTime);
