...
class Picking(models.Model):
    ...
    warranty_order_id = fields.Many2one('warranty_order', ondelete='cascade', string="Warranty Order Id")
    ...
    def action_confirm(self):
        ...
        #             location_id = self.warranty_order_id.vehicle_id.location_stock_id.id  # 车的实库
