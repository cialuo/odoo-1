...
class vehicle_special_check(models.Model):
    ...
    def _add_plan_details(self):
        res = self.env['security_manage.check_table'].search([("function_module", "=", u"安全技术专项抽查")])
        datas = []
    ...
    # 计划详情
    plan_details_id = fields.One2many("security.vehicle_plan_details", "vehicle_special_check_id", default=_add_plan_details)
    # 工作流
