odoo.define("line_map_production_sz_tmp.line_map_production", function(require) {
            ...
            model_choseline.query().filter([
                ...
                config_parameter.query().filter([["key", "=", "dispatch.gdmap.service"]]).all().then(function (gdmap) {
                    ...
                    $.getScript(gdmap_url, function(){
                        new line_map_production_w(self, self.layer, lineData).appendTo(self.$el); 
                    });
                });
            });
        }
    ...
    var line_map_production_w = Widget.extend({
        ...
        init: function(parent, layer_index, lineData) {
            this._super(parent);
        ...
        start: function() {
            ...
            // 加载地图工具栏
            new line_map_production_line_set_w(self, self.lineData, location_set).appendTo(tmp_map_page);
        ...
        load_draw_line_map: function(gprsInfo){
            new map_gprs_w(this, gprsInfo).appendTo(this.$(".mapGprsBox"));
        },
